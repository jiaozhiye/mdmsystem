...
<script>
import {getMaterialRecord, getMaterialSelTree, getStuffToryList, getMaterialUnitInfo, getOrderTypeInfo, getStoreConditionInfo, updateMaterialRecord} from 'api'
        ...
        async getItemInfo(){
            try {
                ...
                if (response.data.code == 1){
                    ...
                    this.form.out_price = response.data.data.out_price
                    this.form.sort = response.data.data.sort
                    this.form.desc = response.data.data.desc
                    this.form.calcNum = response.data.data.unit_num // 计量单位的数值
                    this.form.calc_unit_1 = response.data.data.unit // 计量单位 - 前
                    this.form.calc_unit_2 = response.data.data.unit_big // 计量单位 - 后
                    this.form.packNum = response.data.data.box_attr_num // 装箱单位的数值
                    this.form.pack_unit = response.data.data.box_attr // 装箱单位
                    this.form.take_unit = response.data.data.out_unit // 提货单位
                    this.form.quality_time = response.data.data.shelf_life_num // 保质期
                    this.form.arrival_time = response.data.data.security_time // 到货周期
                    this.form.storeConditionId = response.data.data.storage_condition // 存储条件
                    this.form.orderTypeId = response.data.data.order_type // 订单类型
